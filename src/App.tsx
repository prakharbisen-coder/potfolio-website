    ...
    >
      <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight">Prakhar</span>
        </a>
        ...
        <nav className="hidden md:flex gap-8 text-sm font-medium text-gray-300">
          ...
          <a href="#achievements" className="hover:text-orange-400 transition-colors">Achievements</a>
  ...
  return (
    <div className="min-h-screen bg-[var(--color-brand-dark)] text-white font-sans selection:bg-orange-500 selection:text-white overflow-x-hidden">
      ...
      <footer className="py-8 text-center text-gray-600 text-sm border-t border-white/5">
        <p>© {new Date().getFullYear()} Prakhar Bisen. Built with React & Three.js.</p>
      </footer>
    </div>
  );
}

      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16">
        ...
        >
          ...
          <div className="space-y-6">
            <a href="mailto:prakharbisen790@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-orange-400 transition-colors">
              ...
              <div>
                ...
                <p className="font-medium">prakharbisen790@gmail.com</p>
              </div>
            </a>
            <a href="tel:+919302574484" className="flex items-center gap-4 text-gray-300 hover:text-orange-400 transition-colors">
              <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-orange-400 border border-white/10">
                <Phone className="w-5 h-5" />
              </div>
              <div>
                <p className="text-sm font-light text-gray-500">Phone</p>
                <p className="font-medium">+91-9302574484</p>
              </div>
            </a>
          ...
          <div className="flex gap-4 mt-10">
            <a href="[linkedin url]" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-gray-400 border border-white/10 hover:text-orange-400 hover:border-orange-500/30 transition-all">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="[github url]" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-gray-400 border border-white/10 hover:text-orange-400 hover:border-orange-500/30 transition-all">
              <Github className="w-5 h-5" />
            </a>
            <a href="mailto:prakharbisen790@gmail.com" className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-gray-400 border border-white/10 hover:text-orange-400 hover:border-orange-500/30 transition-all">
              <Mail className="w-5 h-5" />
            </a>
          </div>
        </motion.div>
